...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const googleFormURL =
      "https://docs.google.com/forms/d/e/1FAIpQLSej5zLuE0py92LAQnGEOW6ygd0mRmYwrI7YoNRgK7mU_qNbmg/formResponse";
    ...
    fetch(googleFormURL, {
      ...
      .then(() => {
        ...
        setTimeout(() => {
          router.push(
            "https://portal.jhu.edu.ng/Applicant/ApplicantAccount/SignUp"
  ...
  return (
    <div className="w-full min-h-dvh  py-5 px-6 md:px-0 text-black bg-amber-50">
      ...
      <div className="max-w-[500px] min-h-[300px] mx-auto flex flex-col justify-start items-start gap-6">
        ...
        {success ? (
          <div className="w-full">
            <img src="/successful.gif" alt="Success" className="mx-auto" />
